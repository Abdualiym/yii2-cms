...
class ArticleCategories extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        ...
        return [
            ...
            'slug' => Yii::t('app', 'Slug'),
            'description_0' => Yii::t('app', 'Description') . '(' . $language0 . ')',
            'description_1' => Yii::t('app', 'Description') . '(' . $language1 . ')',
            'description_2' => Yii::t('app', 'Description') . '(' . $language2 . ')',
            'description_3' => Yii::t('app', 'Description') . '(' . $language3 . ')',
